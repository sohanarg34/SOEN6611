...
public class CompositeStatementObject extends AbstractStatement {
	...
	public List<CompositeStatementObject> getDoStatements()
	{
		...
		public List<CompositeStatementObject> getWhileStatement()
		{
			List<CompositeStatementObject> whileStatement = new ArrayList<CompositeStatementObject>();
			if(this.getType().equals(StatementType.WHILE))
				whileStatement.add(this);
			for(AbstractStatement statement : statementList)
			{
				if(statement instanceof CompositeStatementObject)
				{
					CompositeStatementObject composite = (CompositeStatementObject) statement;
					whileStatement.addAll(composite.getWhileStatement());
				}
			}
